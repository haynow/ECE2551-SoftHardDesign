...
TEST_CASE("First Maze", "[maze1]"){
    ...
    if (solvable == true){
        ...
        std::cout << "Maze #1 Solution: " << "Solved!\n" << std::endl;
        showMaze();
        std::cout << std::endl;
    } else {
        std::cout << "Maze #1 Solution: " << "No Solution\n" << std::endl;
    }
}
...
TEST_CASE("Second Maze", "[maze2]"){
    ...
    if (solvable == true){
        ...
        std::cout << "Maze #2 Solution: " << "Solved!\n" << std::endl;
        showMaze();
        std::cout << std::endl;
    } else {
        std::cout << "Maze #2 Solution: " << "No Solution\n" << std::endl;
    }
}
...
TEST_CASE("Third Maze", "[maze3]"){
    ...
    if (solvable == true){
        ...
        std::cout << "Maze #3 Solution: " << "No Solution\n" << std::endl;
    }
...
TEST_CASE("Fourth Maze", "[maze4]"){
    ...
    if (solvable == true){
        ...
        std::cout << "Maze #4 Solution: " << "Solved!\n" << std::endl;
        showMaze();
        std::cout << std::endl;
    } else {
