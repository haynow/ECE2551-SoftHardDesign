...
TEST_CASE("Testing Addition: NoError"){
    ...
    Matrix::Status returnValue = one.add(two);
    REQUIRE(returnValue == Matrix::Status::NoError);
...
TEST_CASE("Testing Addition: DimensionError"){
    ...
    Matrix::Status returnValue = one.add(two);
    REQUIRE(returnValue == Matrix::Status::DimensionError);
...
TEST_CASE("Testing Subtraction: NoError"){
    ...
    Matrix::Status returnValue = one.subtract(two);
    REQUIRE(returnValue == Matrix::Status::NoError);
...
TEST_CASE("Testing Multiplication: Matrix (3x3) - NoError"){
    ...
    Matrix::Status returnValue = one.multiply(two);
    REQUIRE(returnValue == Matrix::Status::NoError);
...
TEST_CASE("Testing Division: NoError"){
    ...
    Matrix::Status returnValue = one.divide(3.0);
    REQUIRE(returnValue == Matrix::Status::NoError);
...
TEST_CASE("Testing Division: DivideByZeroError"){
    ...
    Matrix::Status returnValue = one.divide(0);
    REQUIRE(returnValue == Matrix::Status::DivideByZeroError);
}
